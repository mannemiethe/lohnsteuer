...
module.exports = function Lohnsteuer2021Big(args) {
    ...
    //  ITZBund Berlin
    //   EINGABEPARAMETER
    //  1, wenn die Anwendung des Faktorverfahrens gew├ñhlt wurden (nur in Steuerklasse IV)
    // int
    ...
    //  in VKAPA und VMT enthaltene Entsch├ñdigungen nach ┬º24 Nummer 1 EStG in Cent
    // BigDecimal
    ...
    //  Jahresfreibetrag nach Ma├ƒgabe der Eintragungen auf der
    ...
    //  Voraussichtlicher Jahresarbeitslohn ohne sonstige Bez├╝ge und ohne Verg├╝tung f├╝r mehrj├ñhrige T├ñtigkeit in Cent.
    //                  Anmerkung: Die Eingabe dieses Feldes (ggf. 0) ist erforderlich bei Eingabe ÔÇ×sonsti-ger Bez├╝geÔÇ£ (Feld SONSTB)
    //                  oder bei Eingabe der ÔÇ×Verg├╝tung f├╝r mehrj├ñhrige T├ñtigkeitÔÇ£ (Feld VMT).
    ...
    //                  Abrechnungszeitraum sind in voller H├Âhe hinzuzurechnen.
    // BigDecimal - Implicit Default
    ...
    //                  als Monatsbetrag in Cent (der Wert ist inabh├ñngig vom Lohnzahlungszeitraum immer
    ...
    //                      zu ber├╝cksichtigen w├ñren, sonst 0.
    // int
    ...
    //  Verg├╝tung f├╝r mehrj├ñhrige T├ñtigkeit ohne Kapitalauszahlungen und ohne Abfindungen
    ...
    //  In JRE4 enthaltene Entsch├ñdigungen nach ┬º 24 Nummer 1 EStG in Cent
    // BigDecimal
    var JRE4ENT = (args.JRE4ENT !== undefined) ? new BigDecimal(String(args.JRE4ENT)) : BigDecimal.ZERO;

    //  In SONSTB enthaltene Entsch├ñdigungen nach ┬º 24 Nummer 1 EStG in Cent
    // BigDecimal
    ...
    //  F├╝r den Lohnzahlungszeitraum ber├╝cksichtigte Beitr├ñge des Arbeitnehmers zur
    ...
    //  F├╝r den Lohnzahlungszeitraum ber├╝cksichtigte Beitr├ñge des Arbeitnehmers
    ...
    //                  auch negativ sein. F├╝r tariferm├ñ├ƒigt zu besteuernde Verg├╝tungen f├╝r mehrj├ñhrige
    //                  T├ñtigkeiten enth├ñlt der PAP keinen entsprechenden Ausgabewert.
    ...
    //  Merker f├╝r Berechnung Lohnsteuer f├╝r mehrj├ñhrige T├ñtigkeit.
    //                      0 = normale Steuerberechnung
    //                      1 = Steuerberechnung f├╝r mehrj├ñhrige T├ñtigkeit
    //                      2 = entf├ñllt
    var KENNVMT = 0; // int
    ...
    //  Neu ab 2021: Bemessungsgrundlage des Solidarit├ñtszuschlags zur Pr├╝fung der Freigrenze beim Solidarit├ñtszuschlag f├╝r sonstige Bez├╝ge (ohne Verg├╝tung f├╝r mehrj├ñhrige T├ñtigkeit) in Euro
    var SOLZSBMG = BigDecimal.ZERO; // BigDecimal

    //  Neu ab 2021: Zu versteuerndes Einkommen f├╝r die Ermittlung der Bemessungsgrundlage des Solidarit├ñtszuschlags zur Pr├╝fung der Freigrenze beim Solidarit├ñtszuschlag f├╝r sonstige Bez├╝ge (ohne Verg├╝tung f├╝r mehrj├ñhrige T├ñtigkeit) in Euro, Cent (2 Dezimalstellen)
    var SOLZSZVE = BigDecimal.ZERO; // BigDecimal

    //  Neu ab 2021: Bemessungsgrundlage des Solidarit├ñtszuschlags f├╝r die Pr├╝fung der Freigrenze beim Solidarit├ñtszuschlag f├╝r die Verg├╝tung f├╝r mehrj├ñhrige T├ñtigkeit in Euro
    ...
    //  Zwischenfeld zur Ermittlung der Steuer auf Verg├╝tungen f├╝r mehrj├ñhrige T├ñtigkeit
    ...
    //  Vorsorgepauschale mit Teilbetr├ñgen f├╝r die gesetzliche Kranken- und
    //                      soziale Pflegeversicherung nach fiktiven Betr├ñgen oder ggf. f├╝r die
    ...
    //                      nach Abzug der Freibetr├ñge nach ┬º 39 b Abs. 2 Satz 3 und 4.
    ...
    //  Feste Tabellenfreibetr├ñge (ohne Vorsorgepauschale) in Ôé¼, Cent
    //                      (2 Dezimalstellen)
    ...
    //  Jahreswert der ber├╝cksichtigten Beitr├ñge zur privaten Basis-Krankenversicherung und
        ...
        if (KRV < 2)         //  &lt; = <
{
    ...
    //  Freibetr├ñge f├╝r Versorgungsbez├╝ge, Altersentlastungsbetrag (┬º 39b Abs. 2 Satz 3 EStG), PAP Seite 17
    function MRE4() {
    ...
    //  Ermittlung des Jahresarbeitslohns nach Abzug der Freibetr├ñge nach ┬º 39 b Abs. 2 Satz 3 und 4 EStG, PAP Seite 20
    function MRE4ABZ() {
        ...
        if (ZKF.compareTo(BigDecimal.ZERO) === 1)         //  ZKF > 0
{
    ...
    //  Ermittlung der festen Tabellenfreibetr├ñge (ohne Vorsorgepauschale), PAP Seite 22
    function MZTABFB() {
        ANP = BigDecimal.ZERO;
            ...
            if (SOLZVBMG.compareTo(SOLZFREI) === 1)             //  SOLZVBMG > SOLZFREI
{
    ...
    //  Sonderberechnung ohne sonstige Bez├╝ge f├╝r Berechnung bei sonstigen Bez├╝gen oder Verg├╝tung f├╝r mehrj├ñhrige T├ñtigkeit, PAP Seite 36
    function MOSONST() {
    ...
    //  Sonderberechnung mit sonstige Bez├╝ge f├╝r Berechnung bei sonstigen Bez├╝gen oder Verg├╝tung f├╝r mehrj├ñhrige T├ñtigkeit, PAP Seite 37
    function MRE4SONST() {
        MRE4();
        FVB = FVBSO;
        MRE4ABZ();
    ...
    function UPTAB21() {
        ...
        if (X.compareTo(GFB.add(ZAHL1)) === -1) {
            ...
            if (X.compareTo(new BigDecimal("14754")) === -1)             //  Ge├ñndert f├╝r 2021
{
                ...
                if (X.compareTo(new BigDecimal("57919")) === -1)                 //  Ge├ñndert f├╝r 2021
{
                    ...
                    if (X.compareTo(new BigDecimal("274613")) === -1)                     //  Ge├ñndert f├╝r 2021
{
